...
ensure_panel_env_file() {
  ...
  set_env_value FLUX_FORCE_SECURE_NODE_TRANSPORT "$(env_value_or_default FLUX_FORCE_SECURE_NODE_TRANSPORT "${FLUX_FORCE_SECURE_NODE_TRANSPORT:-false}")"
...
FLUX_FORCE_SECURE_NODE_TRANSPORT=${FLUX_FORCE_SECURE_NODE_TRANSPORT:-false}
